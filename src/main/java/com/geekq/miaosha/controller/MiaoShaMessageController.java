...
public class MiaoShaMessageController {
  ...
  @Autowired private MiaoShaMessageService messageService;
  @Autowired private MQSender sendMessage;
  ...
  public String list(@RequestParam(value = "userid", required = true) String userId, Model model) {
    ...
    List<MiaoShaMessageInfo> miaoShaMessageInfos =
        messageService.getmessageUserList(Long.valueOf(userId), null);
  ...
  public String getNewMessage(
    ...
    List<MiaoShaMessageInfo> miaoShaMessageInfos =
        messageService.getmessageUserList(Long.valueOf(userId), MessageStatus.ZORE);
