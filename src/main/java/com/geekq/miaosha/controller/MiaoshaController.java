...
public class MiaoshaController implements InitializingBean {
  ...
  /** QPS:1306 5000 * 10 get　post get 幂等　从服务端获取数据　不会产生影响　　post 对服务端产生变化 */
  ...
  public ResultGeekQ<Integer> miaosha(
    ...
    // 是否已经秒杀到
    MiaoshaOrder order =
        orderService.getMiaoshaOrderByUserIdGoodsId(Long.valueOf(user.getNickname()), goodsId);
    if (order != null) {
  ...
  @ResponseBody
  public ResultGeekQ<Long> miaoshaResult(
  ...
  @ResponseBody
  public ResultGeekQ<String> getMiaoshaPath(
  ...
  @ResponseBody
  public ResultGeekQ<String> getMiaoshaVerifyCod(
