...
public class MiaoshaService {
  ...
  public boolean checkPath(MiaoshaUser user, long goodsId, String path) {
    ...
    String pathOld =
        redisService.get(
            MiaoshaKey.getMiaoshaPath, "" + user.getNickname() + "_" + goodsId, String.class);
  ...
  public boolean checkVerifyCodeRegister(int verifyCode) {
    Integer codeOld =
        redisService.get(MiaoshaKey.getMiaoshaVerifyCodeRegister, "regitser", Integer.class);
  ...
  public boolean checkVerifyCode(MiaoshaUser user, long goodsId, int verifyCode) {
    ...
    Integer codeOld =
        redisService.get(
            MiaoshaKey.getMiaoshaVerifyCode, user.getNickname() + "," + goodsId, Integer.class);
    if (codeOld == null || codeOld - verifyCode != 0) {
      return false;
    }
