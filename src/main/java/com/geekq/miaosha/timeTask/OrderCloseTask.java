...
public class OrderCloseTask {
  ...
  //        long lockTime = 5000;
  //        Long setnxResult =
  // redisService.setnx(CLOSE_ORDER_INFO_TASK_LOCK,String.valueOf(System.currentTimeMillis()+lockTime));
  //        //代表获取了锁
  ...
  public void closeOrderTaskV3() {
    ...
    Long setnxResult =
        redisService.setnx(
            CLOSE_ORDER_INFO_TASK_LOCK, String.valueOf(System.currentTimeMillis() + lockTime));
    // 代表获取了锁
    if (setnxResult != null && setnxResult == 1) {
      closeOrder(CLOSE_ORDER_INFO_TASK_LOCK);
    } else {
